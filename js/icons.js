/* FlatCircle · 线性图标库（内联 SVG，stroke 风格，无外部依赖） */
window.FC = window.FC || {};
(function (FC) {
  'use strict';

  const P = {
    home: '<path d="M3 9.5 12 3l9 6.5V20a1.5 1.5 0 0 1-1.5 1.5H15v-7H9v7H4.5A1.5 1.5 0 0 1 3 20z"/>',
    ...
    bookmarkOff: '<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>',
  ...
  FC.Icon = {
    ...
    computed: {
      inner() { return P[this.name] || P.info; }
    },
    template:
      ...
      'aria-hidden="true" v-html="inner"></svg>'
  };
})(window.FC);
